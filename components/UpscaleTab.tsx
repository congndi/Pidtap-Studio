    ...
    return (
        <div className="space-y-6">
            <div className="text-center">
                ...
                <p className="text-sm text-gray-400 mt-1">AI sẽ tăng cường độ phân giải và độ sắc nét của ảnh.</p>
            </div>
            <div className="max-w-md mx-auto">
                ...
                />
                {resolutionInfo && (
                    <p className="text-center text-sm text-gray-400 mt-3 animate-fade-in">
                        <i className="fa-solid fa-ruler-combined mr-2"></i>
                        {resolutionInfo}
                    </p>
                )}
                {resolutionWarning && (
                     <p className="text-center text-sm text-yellow-400 mt-2 p-3 bg-yellow-900/30 border border-yellow-700/50 rounded-lg animate-fade-in">
